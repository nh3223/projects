...
import { annualize, getBaseAmount, getParachuteThreshold } from '../../../../utilities/compensation/baseAmount/baseAmount';
...
const BaseAmount = ({ executiveId }) => {
  ...
  const annualizedCompensation = annualize(parse(startDate), firstYearPayments, firstBasePeriodCompensationYear);
