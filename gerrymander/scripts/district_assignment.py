...
class DistrictAssignment:
    ...
    def __init__(self, model_parameters, assignment_type='random', district_centers=None):

        self.census_tracts = model_parameters.census_tracts
        self.number_of_districts = model_parameters.number_of_districts
        self.target_district_population = model_parameters.get_target_district_population
    ...
    def run_population_adjustment(self):
        ...
        def get_district_order(self):
            district_order = []
            for district in self.districts:
                distance = get_squared_distance(district['center'], self.state_center)
